...
local function createWidget(name, text, fontsize,width,height,margin,bgcolor,textcolor)
	...
	if (margin ~= nil) then
	button:SetMargin(inkMargin.new(margin))
	end
...
function UIButton.Create(name, text, fontsize,width,height,controls,bgcolor,textcolor)
	local root = createWidget(name, text, fontsize,width,height,controls,bgcolor,textcolor)
